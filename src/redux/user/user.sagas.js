...
export function* mySignInStart({payload: {email, password}}) {
    try {
...
export function* onMySignInStart() {
    yield takeLatest(UserActionTypes.MY_SIGN_IN_START, mySignInStart);
}
